...
const questionData = {
    ...
    2: {
        ...
        content: "ฉันเคยหยุดออกกำลังกายเพราะเปรียบเทียบตัวเองกับคนอื่น\nสุดท้ายเริ่มจากเบา ๆ และทำต่อเนื่องวันละเล็กน้อย\nตอนนี้รู้สึกมั่นใจและมีแรงมากขึ้น",
...
const QuestionContent = () => {
    ...
    const question = liveQuestion || questionData[id] || questionData[1];
